...
Examples:
  ...
  %(prog)s list
    ...
    encrypt_parser.add_argument('--shift', type=int, help='Shift value for Caesar cipher')
    encrypt_parser.add_argument('--key', help='Key for key-based ciphers')
    encrypt_parser.add_argument('--a', type=int, help='Parameter a for Affine cipher')
    encrypt_parser.add_argument('--b', type=int, help='Parameter b for Affine cipher')
    encrypt_parser.add_argument('--rails', type=int, help='Number of rails for Rail Fence cipher')
    encrypt_parser.add_argument('--key-size', type=int, help='Key size for RSA cipher')
    ...
    decrypt_parser.add_argument('--shift', type=int, help='Shift value for Caesar cipher')
    decrypt_parser.add_argument('--key', help='Key for key-based ciphers')
    decrypt_parser.add_argument('--a', type=int, help='Parameter a for Affine cipher')
    decrypt_parser.add_argument('--b', type=int, help='Parameter b for Affine cipher')
    decrypt_parser.add_argument('--rails', type=int, help='Number of rails for Rail Fence cipher')
    decrypt_parser.add_argument('--key-size', type=int, help='Key size for RSA cipher')
